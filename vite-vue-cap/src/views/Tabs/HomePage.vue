          ...
          <ion-popover trigger="popover-button" :dismiss-on-select="true">
            <ion-content>
              <ion-list style="padding-bottom: 0px;">
                <ion-item :button="true" :detail="false"><ion-icon class="icons-style" style="margin-right: 4%;" :icon="star" @click="redirectToGooglePlay"></ion-icon>Rating</ion-item>
                <ion-item :button="true" :detail="false" @click="sendEmail"><ion-icon class="icons-style" style="margin-right: 4%;" :icon="mail"></ion-icon> Write me</ion-item>
                <ion-item :button="true" :detail="false" @click="openAboutModal">
                  <svg style="margin-right: 4%;" width="30px" height="30px" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#757575" stroke="#757575">
      ...
      <div class="calendar-content">
        <div pager="true" style="width: 100%">
          ...
          <div style="width: 100%">
            <swiper :loop="true">
              <swiper-slide>
                <CalendarComponent :showDatePicker="showDatePicker" @move-forward="handleMoveForward" @move-backward="handleMoveBackward" @update:selectedDate="updateSelectedDate"></CalendarComponent>
      ...
      <ion-content class="ion-padding">
        <div class="library-container">
          ...
          <ul class="book-list" style="list-style-type: none">
            <li> <a href="http://www.pravoslavieto.com/toc/chitalnja.htm" target=_blank><img width=158 height=23 src="http://www.pravoslavieto.com/images/felles/logo_small.gif" alt="ПРАВОСЛАВНАТА ЧИТАЛНЯ. Eastern Orthodox readings in Bulgarian at Pravoslavieto.com" border=0></a> </li>
            <li><a href="http://www.sviatost.info/12_jitiya_na_svetiite/index.html" target=_blank><img width=158 height=23></a>http://www.sviatost.info</li>
            <li><a href="https://bg-patriarshia.bg/calendar/2024" target=_blank><img width=158 height=23 src=""></a>https://bg-patriarshia.bg/calendar</li>
            <li>Resource 3</li>
